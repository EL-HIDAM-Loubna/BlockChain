 ...
 */
final class Version20201006160908 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE time time DATE NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE time time DATE DEFAULT NULL');
    }
}
